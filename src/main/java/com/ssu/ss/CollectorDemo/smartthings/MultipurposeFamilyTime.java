...
public class MultipurposeFamilyTime extends SmartThings {
	...
	public MultipurposeFamilyTime(JSONObject smartInfo) {
	...
	public void init() {
		...
		deviceUri = smartInfo.get("device_uri").toString() + "/" + SmartThingsConstants.MULTI_2_ID;
	...
	public void responseDeviceInfo() {
		...
		while(true) {
			...
			if (currentDeviceInfo == null) {}
				...
				System.out.println("["+this.getClass()+"] valueInfo : "+ valueInfo);
				String boolValue = valueInfo.get(SmartThingsConstants.MULTI).toString();
			...
			sensorCollectionInfo.put("sensortype", SmartThingsConstants.MULTI_2_RESPONSE_ID);
			sensorCollectionInfo.put("regTime", regtime);
			
			System.out.println("["+this.getClass()+"] sensorCollectionInfo : "+ sensorCollectionInfo.toJSONString());
			
			HttpClient httpClient = HttpClients.createDefault();
			HttpPost httpPost = new HttpPost(SmartThingsConstants.URL);
			List<NameValuePair> params = new ArrayList<NameValuePair>();
			
			params.add(new BasicNameValuePair("id", SmartThingsConstants.MULTI_2_RESPONSE_ID));
			...
			try { 
				...
				{ // EntityUtils to get the response content 
					...
					System.out.println("["+this.getClass()+"] res : "+content);
				}
			}
