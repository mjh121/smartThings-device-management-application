...
public class MultipurposeWokeup extends SmartThings{
	...
	public MultipurposeWokeup(JSONObject smartInfo) {
	...
	public void init() {
		...
		deviceUri = smartInfo.get("device_uri").toString() + "/" + SmartThingsConstants.MULTI_3_ID;
	...
	public void responseDeviceInfo() {
		...
		while(true) {
			...
			sensorCollectionInfo.put("sensortype", SmartThingsConstants.MULTI_3_RESPONSE_ID);
			...
			params.add(new BasicNameValuePair("id", SmartThingsConstants.MULTI_3_RESPONSE_ID));
