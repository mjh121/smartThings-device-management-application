...
public class MotionBathIn extends SmartThings {
	// Motion sensor No.1 - Bath in
	...
	public MotionBathIn(JSONObject smartInfo) {
		this.smartInfo = smartInfo;
		System.out.println(smartInfo);
	}

	@Override
	public void init() {
		// TODO Auto-generated method stub
		deviceUri = smartInfo.get("device_uri").toString() + "/" + SmartThingsConstants.MOTION_1_ID;
		...
		System.out.println("endPointParamd : " + endPointParamd);
	...
	public void responseDeviceInfo() {
		...
		while(true) { 
			...
			sensorCollectionInfo.put("sensortype", SmartThingsConstants.MOTION_1_RESPONSE_ID);
			...
			params.add(new BasicNameValuePair("id", SmartThingsConstants.MOTION_1_RESPONSE_ID));
